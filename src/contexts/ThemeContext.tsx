...
const COLOR_OPTIONS = [
  { name: 'solar', color: '#1E3A5F' },
  { name: 'ocean', color: '#2563EB' },
  { name: 'sunrise', color: '#D97706' },
  { name: 'aurora', color: '#0D9488' },
  { name: 'cosmos', color: '#4F46E5' },
];
...
export function ThemeProvider({ children }: { children: ReactNode }): ReactElement {
  ...
  const [colorTheme, setColorThemeState] = useState(() => getCookie('color_theme') || 'solar');
