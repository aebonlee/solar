import{j as e,a as E}from"./index-Bmc741zQ.js";import{u as G}from"./useAOS-Y5VT5uWa.js";const n=148,c=52,b=38,S=30,h=16,B={1:{nodes:[{id:"a",label:"사용자 입력",sub:"나이·주제",row:0,col:0},{id:"b",label:"Solar Chat",sub:"스토리 생성",row:0,col:1},{id:"c",label:"장면 분할기",sub:"5~8 장면",row:0,col:2},{id:"d",label:"삽화 프롬프트",sub:"생성기",row:1,col:2},{id:"e",label:"독후활동 생성",sub:"질문·교훈",row:1,col:1},{id:"f",label:"동화 뷰어",sub:"최종 출력",row:2,col:1}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"d"},{from:"d",to:"e"},{from:"e",to:"f"}]},2:{nodes:[{id:"a",label:"문화재청 API",sub:"공공데이터",row:0,col:0},{id:"b",label:"전처리·청킹",sub:"텍스트 분할",row:0,col:1},{id:"c",label:"Solar Embed",sub:"벡터화",row:0,col:2},{id:"d",label:"수준별 해설",sub:"+ 퀴즈 출력",row:1,col:0},{id:"e",label:"Solar Chat",sub:"RAG 생성",row:1,col:1},{id:"f",label:"pgvector",sub:"벡터 검색",row:1,col:2},{id:"g",label:"사용자 질의",sub:"문화재·수준",row:2,col:1}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"f"},{from:"f",to:"e"},{from:"e",to:"d"},{from:"g",to:"f"},{from:"g",to:"d"}]},3:{nodes:[{id:"a",label:"한국사 DB",sub:"시대별 구조",row:0,col:0},{id:"b",label:"수준별 설명",sub:"Solar 생성",row:0,col:1},{id:"c",label:"학습 뷰어",sub:"읽기·듣기",row:0,col:2},{id:"d",label:"문제 생성",sub:"유형별",row:1,col:0},{id:"e",label:"풀이 & 채점",row:1,col:1},{id:"f",label:"오답 분석",sub:"+ 리포트",row:1,col:2},{id:"g",label:"적응형 복습",sub:"취약 시대",row:2,col:2}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"a",to:"d"},{from:"c",to:"f"},{from:"d",to:"e"},{from:"e",to:"f"},{from:"f",to:"g"}]},4:{nodes:[{id:"a",label:"문제 은행",sub:"자격증별",row:0,col:0},{id:"b",label:"문제 풀기",sub:"사용자",row:0,col:1},{id:"c",label:"자동 채점",sub:"+ 단원 태깅",row:0,col:2},{id:"d",label:"유사문제 생성",sub:"Solar Chat",row:1,col:0},{id:"e",label:"보충학습",sub:"계획 생성",row:1,col:1},{id:"f",label:"취약점 분석",sub:"단원별 통계",row:1,col:2}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"f"},{from:"f",to:"e"},{from:"e",to:"d"},{from:"d",to:"a"}]},5:{nodes:[{id:"a",label:"정책 데이터",sub:"브리핑·온통",row:0,col:0},{id:"b",label:"Solar Embed",sub:"벡터화",row:0,col:1},{id:"c",label:"pgvector",sub:"정책 DB",row:0,col:2},{id:"d",label:"사용자 대화",sub:'"나 25살..."',row:1,col:0},{id:"e",label:"프로파일 파악",sub:"나이·지역",row:1,col:1},{id:"f",label:"정책 매칭",sub:"RAG 검색",row:1,col:2},{id:"g",label:"쉬운말 안내",sub:"Solar Chat",row:2,col:2}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"f"},{from:"d",to:"e"},{from:"e",to:"f"},{from:"f",to:"g"}]},6:{nodes:[{id:"a",label:"경험 입력",sub:"자유 기술",row:0,col:0},{id:"b",label:"STAR 변환",sub:"구조화",row:0,col:1},{id:"c",label:"자소서 생성",sub:"문항별",row:0,col:2},{id:"d",label:"면접 코칭",sub:"Q&A 생성",row:1,col:1},{id:"e",label:"문장 피드백",sub:"개선 제안",row:1,col:2}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"e"},{from:"e",to:"d"}]},7:{nodes:[{id:"a",label:"감정 체크인",sub:'"오늘 기분?"',row:0,col:0},{id:"b",label:"상태 분석",sub:"수준·키워드",row:0,col:1},{id:"c",label:"루틴 추천",sub:"맞춤 1가지",row:0,col:2},{id:"d",label:"회복 트래커",sub:"추이 그래프",row:1,col:1},{id:"e",label:"격려 메시지",sub:"+ 성찰 질문",row:1,col:2},{id:"f",label:"루틴 수행",sub:"확인 (체크)",row:2,col:1}],arrows:[{from:"a",to:"b"},{from:"b",to:"c"},{from:"c",to:"e"},{from:"e",to:"d"},{from:"f",to:"d"}]}},$=({projectId:s,color:t})=>{const a=B[s];if(!a)return null;const{nodes:p,arrows:w}=a,f=Object.fromEntries(p.map(o=>[o.id,o])),v=Math.max(...p.map(o=>o.col)),I=Math.max(...p.map(o=>o.row)),_=(v+1)*(n+b)-b+h*2,C=(I+1)*(c+S)-S+h*2,x=o=>({x:h+o.col*(n+b),y:h+o.row*(c+S),cx:h+o.col*(n+b)+n/2,cy:h+o.row*(c+S)+c/2}),T=o=>{const i=f[o.from],d=f[o.to];if(!i||!d)return null;const r=x(i),l=x(d),m=d.col-i.col,u=d.row-i.row;if(u===0&&m>0)return`M${r.x+n},${r.cy} L${l.x},${l.cy}`;if(u===0&&m<0)return`M${r.x},${r.cy} L${l.x+n},${l.cy}`;if(m===0&&u>0)return`M${r.cx},${r.y+c} L${l.cx},${l.y}`;if(m===0&&u<0)return`M${r.cx},${r.y} L${l.cx},${l.y+c}`;if(u>0){const P=r.cx,k=r.y+c,O=m>0?l.x:l.x+n,y=l.cy;return`M${P},${k} Q${P},${y} ${O},${y}`}const N=m>0?r.x+n:r.x,A=r.cy,j=l.cx,R=l.y+c;return`M${N},${A} Q${j},${A} ${j},${R}`},g=`arr-${s}`;return e.jsxs("svg",{viewBox:`0 0 ${_} ${C}`,className:"flow-diagram-svg",children:[e.jsx("defs",{children:e.jsx("marker",{id:g,markerWidth:"8",markerHeight:"6",refX:"7",refY:"3",orient:"auto",children:e.jsx("polygon",{points:"0,0 8,3 0,6",fill:t,fillOpacity:"0.7"})})}),w.map((o,i)=>{const d=T(o);return d?e.jsx("path",{d,fill:"none",stroke:t,strokeWidth:"1.5",strokeOpacity:"0.45",markerEnd:`url(#${g})`},i):null}),p.map(o=>{const i=x(o);return e.jsxs("g",{children:[e.jsx("rect",{x:i.x,y:i.y,width:n,height:c,rx:10,fill:"#fff",stroke:t,strokeWidth:"1.5",strokeOpacity:"0.6"}),e.jsx("text",{x:i.cx,y:o.sub?i.cy-7:i.cy+1,textAnchor:"middle",dominantBaseline:"middle",fontSize:"11.5",fontWeight:"600",fill:"#1f2937",children:o.label}),o.sub&&e.jsx("text",{x:i.cx,y:i.cy+9,textAnchor:"middle",dominantBaseline:"middle",fontSize:"9.5",fill:"#9ca3af",children:o.sub})]},o.id)})]})};function L({project:s}){return G(),e.jsxs("div",{className:"project-detail",children:[e.jsxs("section",{className:"project-detail-hero","data-aos":"fade-up",style:{borderLeftColor:s.color},children:[e.jsxs("div",{className:"project-detail-badge",style:{background:`${s.color}15`,color:s.color},children:[e.jsx("i",{className:`fas ${s.icon}`})," Project ",s.id]}),e.jsx("h1",{children:s.title}),e.jsx("p",{className:"project-detail-subtitle",children:s.subtitle})]}),e.jsxs("section",{className:"project-section","data-aos":"fade-up",children:[e.jsxs("h2",{children:[e.jsx("i",{className:"fas fa-circle-info"})," 프로젝트 개요"]}),e.jsxs("div",{className:"card",style:{padding:"1.5rem"},children:[e.jsx("p",{style:{lineHeight:"1.8",marginBottom:"1.5rem"},children:s.overview}),e.jsxs("div",{className:"project-meta-grid",children:[e.jsxs("div",{children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-users"})," 주요 대상"]}),e.jsx("ul",{children:s.targetUsers.map((t,a)=>e.jsx("li",{children:t},a))})]}),e.jsxs("div",{children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-bullseye"})," 학습 목표"]}),e.jsx("ul",{children:s.objectives.map((t,a)=>e.jsx("li",{children:t},a))})]})]})]})]}),e.jsxs("section",{className:"project-section","data-aos":"fade-up",children:[e.jsxs("h2",{children:[e.jsx("i",{className:"fas fa-sitemap"})," 시스템 아키텍처"]}),e.jsxs("div",{className:"card",style:{padding:"1.5rem"},children:[e.jsx("p",{style:{marginBottom:"1.5rem"},children:s.architecture.description}),e.jsx("div",{className:"architecture-diagram",children:e.jsx($,{projectId:s.id,color:s.color})}),e.jsx("div",{className:"architecture-components",children:s.architecture.components.map((t,a)=>e.jsxs("div",{className:"arch-component",children:[e.jsx("h4",{children:t.name}),e.jsx("p",{children:t.description}),e.jsx("span",{className:"tech-badge",children:t.tech})]},a))})]})]}),e.jsxs("section",{className:"project-section","data-aos":"fade-up",children:[e.jsxs("h2",{children:[e.jsx("i",{className:"fas fa-arrows-spin"})," 데이터 파이프라인"]}),e.jsx("div",{className:"pipeline-steps",children:s.pipeline.steps.map(t=>e.jsxs("div",{className:"pipeline-step card",children:[e.jsx("div",{className:"pipeline-step-number",style:{background:s.color},children:t.step}),e.jsxs("div",{className:"pipeline-step-content",children:[e.jsx("h4",{children:t.title}),e.jsx("p",{children:t.description}),e.jsx("span",{className:"tech-badge",children:t.tools})]})]},t.step))})]}),e.jsxs("section",{className:"project-section","data-aos":"fade-up",children:[e.jsxs("h2",{children:[e.jsx("i",{className:"fas fa-sun"})," Solar API 활용"]}),e.jsxs("div",{className:"card",style:{padding:"1.5rem"},children:[e.jsx("p",{style:{marginBottom:"1.5rem"},children:s.solarApi.description}),s.solarApi.endpoints.map((t,a)=>e.jsxs("div",{className:"api-endpoint",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-plug"})," ",t.name]}),e.jsx("p",{children:t.purpose}),e.jsx("div",{className:"code-block",children:e.jsx("code",{children:t.example})})]},a))]})]}),e.jsxs("section",{className:"project-section","data-aos":"fade-up",children:[e.jsxs("h2",{children:[e.jsx("i",{className:"fas fa-wand-magic-sparkles"})," 프롬프트 엔지니어링"]}),e.jsxs("div",{className:"card",style:{padding:"1.5rem"},children:[e.jsx("p",{style:{marginBottom:"1.5rem"},children:s.prompts.description}),s.prompts.examples.map((t,a)=>e.jsxs("div",{className:"prompt-example",children:[e.jsx("h4",{children:t.title}),e.jsx("div",{className:"prompt-block",children:e.jsx("pre",{children:t.prompt})}),e.jsxs("p",{className:"prompt-note",children:[e.jsx("i",{className:"fas fa-lightbulb"})," ",t.note]})]},a))]})]}),e.jsxs("section",{className:"project-section","data-aos":"fade-up",children:[e.jsxs("h2",{children:[e.jsx("i",{className:"fas fa-code"})," 구현 가이드"]}),e.jsxs("div",{className:"implementation-grid",children:[e.jsxs("div",{className:"card",style:{padding:"1.5rem"},children:[e.jsxs("h3",{children:[e.jsx("i",{className:"fas fa-display",style:{color:"#3B82F6"}})," 프론트엔드"]}),e.jsx("p",{children:s.implementation.frontend.description}),e.jsx("p",{className:"tech-badge",children:s.implementation.frontend.stack}),e.jsx("h4",{children:"주요 페이지"}),e.jsx("ul",{children:s.implementation.frontend.pages.map((t,a)=>e.jsx("li",{children:t},a))})]}),e.jsxs("div",{className:"card",style:{padding:"1.5rem"},children:[e.jsxs("h3",{children:[e.jsx("i",{className:"fas fa-server",style:{color:"#10B981"}})," 백엔드"]}),e.jsx("p",{children:s.implementation.backend.description}),e.jsx("p",{className:"tech-badge",children:s.implementation.backend.stack}),e.jsx("h4",{children:"API 엔드포인트"}),e.jsx("ul",{children:s.implementation.backend.apis.map((t,a)=>e.jsx("li",{children:t},a))})]})]}),e.jsxs("div",{className:"card",style:{padding:"1.5rem",marginTop:"1rem"},children:[e.jsxs("h3",{children:[e.jsx("i",{className:"fas fa-database",style:{color:"#8B5CF6"}})," 데이터베이스"]}),e.jsx("div",{className:"db-tables",children:s.implementation.database.tables.map((t,a)=>e.jsxs("div",{className:"db-table",children:[e.jsx("h4",{children:t.name}),e.jsx("code",{children:t.fields})]},a))})]})]}),e.jsxs("section",{className:"project-section","data-aos":"fade-up",children:[e.jsxs("h2",{children:[e.jsx("i",{className:"fas fa-cloud-arrow-up"})," 배포 계획"]}),e.jsxs("div",{className:"card",style:{padding:"1.5rem"},children:[e.jsx("p",{className:"tech-badge",style:{marginBottom:"1rem"},children:s.deployment.infra}),e.jsx("ol",{className:"deployment-steps",children:s.deployment.steps.map((t,a)=>e.jsx("li",{children:t},a))})]})]}),e.jsxs("section",{className:"project-section","data-aos":"fade-up",children:[e.jsxs("h2",{children:[e.jsx("i",{className:"fas fa-rocket"})," 확장 가능성"]}),e.jsx("div",{className:"card",style:{padding:"1.5rem"},children:e.jsx("ul",{className:"expansion-list",children:s.expansion.map((t,a)=>e.jsxs("li",{children:[e.jsx("i",{className:"fas fa-check-circle",style:{color:s.color}})," ",t]},a))})})]})]})}const F=[{id:1,title:"한국형 AI 동화책 제작 앱",subtitle:"한국적 소재와 아이의 나이, 주제를 입력하면 맞춤형 동화책을 생성하는 앱",color:"#EC4899",icon:"fa-book-open-reader",overview:"한국의 전래동화, 명절, 지역 설화 등 한국적 소재를 활용하여 아이의 나이와 관심 주제에 맞는 동화를 Solar LLM이 자동 생성합니다. 각 장면마다 삽화 프롬프트가 함께 생성되며, 독후활동 질문까지 자동으로 제공하여 교육적 가치를 극대화합니다.",targetUsers:["유아·초등학생 (5~12세)","학부모","유치원·초등학교 교사","도서관 교육 담당자","다문화 가정 학부모"],objectives:["Solar Chat API를 활용한 구조화된 스토리 생성 파이프라인 구축","연령별 어휘 수준 조절 프롬프트 설계","장면 분할 및 삽화 프롬프트 자동 생성","교육적 독후활동 질문 생성 시스템 구현","React 기반 동화 뷰어 UI 개발"],architecture:{description:"사용자 입력(나이, 주제, 소재) → Solar LLM 스토리 생성 → 장면 분할 → 삽화 프롬프트 생성 → 독후활동 생성의 순차 파이프라인 구조",components:[{name:"입력 폼",description:"아이 나이, 주제, 한국 소재 선택 UI",tech:"React + Tailwind"},{name:"스토리 엔진",description:"Solar Chat API로 동화 생성 및 장면 분할",tech:"Solar Chat API"},{name:"삽화 생성기",description:"각 장면의 시각적 설명을 이미지 프롬프트로 변환",tech:"Solar Chat API"},{name:"교육 모듈",description:"독후활동 질문, 교훈 추출, 어휘 목록 생성",tech:"Solar Chat API"},{name:"뷰어",description:"페이지 넘기기 UX, 오디오 재생(TTS)",tech:"React + Web Speech API"}],diagram:`┌─────────────┐     ┌──────────────┐     ┌──────────────┐
